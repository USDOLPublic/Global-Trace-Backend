...
export class UpdateFullTextSearchTableFacility1646902593684 extends BaseMigration {
    async run(queryRunner: QueryRunner) {
        ...
        await queryRunner.manager.query(`
            UPDATE "Facility" SET "fullTextSearchable" =
                to_tsvector('simple', coalesce("name", '') || ' ' || coalesce("traderName", '') || ' ' || coalesce("oarId", '') || ' ' || coalesce("businessRegisterNumber", ''));
        `);
        await queryRunner.manager.query(`
        ...
        await queryRunner.manager.query(
            ...
            tsvector_update_trigger("fullTextSearchable", 'pg_catalog.simple', "name", "traderName", "oarId", "businessRegisterNumber");`
        );
    }
